...
import { loadMediaFiles, MEDIA_UPDATED_EVENT } from "@/features/admin/media/lib/media-repository";
...
interface CakeMediaPickerProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSelect: (url: string) => void;
}

export function CakeMediaPicker({ open, onOpenChange, onSelect }: CakeMediaPickerProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Select an image for this cake. Upload new files from the Media Library page.
          </DialogDescription>
        </DialogHeader>
