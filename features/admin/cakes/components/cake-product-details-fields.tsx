...
import type { CakeProductDetails } from "@/types/cake";
import { adminTextareaClassName } from "./admin-field";

interface CakeProductDetailsFieldsProps {
  value: CakeProductDetails & { ingredients?: string };
  onChange: (patch: Partial<CakeProductDetails & { ingredients?: string }>) => void;
}

export function CakeProductDetailsFields({ value, onChange }: CakeProductDetailsFieldsProps) {
  return (
