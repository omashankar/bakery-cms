...
import type { ProductVariantGroup, ProductVariantGroupType } from "@/types/cake";
...
interface CakeVariantManagerProps {
...
export function CakeVariantManager({ groups, basePrice, onChange }: CakeVariantManagerProps) {
