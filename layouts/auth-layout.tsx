...
export function AuthLayoutShell({ children, className }: AuthLayoutShellProps) {
  return (
    <div className={cn("min-h-dvh bg-cream-100 text-foreground", className)}>
      <div className="grid min-h-dvh lg:grid-cols-[minmax(280px,38%)_minmax(0,62%)]">
        {/* Brand plane */}
        <aside className="relative hidden bg-bakery-900 lg:flex">
          ...
          <div className="flex w-full flex-col justify-center px-10 py-14 xl:px-14">
            <motion.div
        ...
        {/* Form column */}
        <main className="relative flex flex-col justify-center px-5 py-12 sm:px-10 lg:px-16 xl:px-24">
          <motion.div
