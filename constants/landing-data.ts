...
export const featuredCakes: LandingCake[] = [
  ...
  },
  {
    ...
    price: 1149,
    image: unsplash(demoPhotoIds.stackCake, 600, 600),
    category: "Premium",
    badge: "Bestseller",
    rating: 4.8,
  },
...
export const weddingCakes: LandingCake[] = [
  ...
  },
  {
    ...
    price: 12499,
    image: unsplash(demoPhotoIds.cookies, 600, 800),
    category: "Wedding",
    rating: 4.9,
  },
  {
...
export const galleryImages = [
  unsplash(demoPhotoIds.chocolateCake, 400, 400),
  unsplash(demoPhotoIds.dessertPlate, 400, 400),
  unsplash(demoPhotoIds.pastries, 400, 400),
  unsplash(demoPhotoIds.weddingCake, 400, 500),
  unsplash(demoPhotoIds.cupcakes, 400, 400),
  unsplash(demoPhotoIds.cookies, 400, 500),
  unsplash(demoPhotoIds.stackCake, 400, 400),
  unsplash(demoPhotoIds.tiramisu, 400, 400),
];
